...
AI猎头助手是面向猎头行业的 AI 助手平台。平台以「技能」为核心抽象，将猎头业务流程（候选人搜索、简历匹配、外联消息撰写、客户维护等）封装为可插拔的 AI 技能，通过统一的对话界面调度执行。
...
### 技能系统
- **内置猎头技能**：候选人搜索、简历-JD 匹配、外联消息生成、客户维护、搜索报告等开箱即用
...
```json
{
  ...
  "enabled_skills": ["headhunter-candidate-sourcing"],
  "attachments": [
    {
      "type": "file",
      "url": "https://...",
